...
import { createTemathic } from "../../services/temathic.service";
import styles from "./CreateTemathic.module.css";
import type { FormEvent } from "react";

export const CreateTemathic = () => {
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    createTemathic(data, token).then((response) => {
      console.log(response);
    });
  };

  return (
    <form className={styles.createTemathicContainer} onSubmit={handleSubmit}>
      <div className={styles.inputLabel}>
        <label htmlFor="temathic">Temathic:</label>
      ...
      <button type="submit">Create Temathic</button>
    </form>
  );
};
